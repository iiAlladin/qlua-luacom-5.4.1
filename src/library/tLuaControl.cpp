...
*/
//STDMETHODIMP tLuaControl::Load(LPSTREAM*pStream)
STDMETHODIMP tLuaControl::Load(LPSTREAM pStm)
{
  return S_OK;
}
...
*/
//STDMETHODIMP tLuaControl::Save(LPSTREAM *pStream, BOOL fClearDirty)
// NOLINTNEXTLINE(VCR102)
STDMETHODIMP tLuaControl::Save(LPSTREAM pStm, BOOL fClearDirty)
{
  return S_OK;
}
