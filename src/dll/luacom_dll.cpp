#include <windows.h>
#include <unknwn.h> // Добавьте этот заголовок для аннотаций интерфейсов COM
extern "C" {
  #include "lua.h"
  #include "lualib.h"
  #include "lauxlib.h"
...
// Используем определение из SDK чтобы совпали аннотации SAL:
           ...
           )
{
  ...
  if(ul_reason_for_call == DLL_PROCESS_ATTACH) {
    ...
    if (FAILED(hr)) {
      // Можно добавить логирование или обработку ошибки, если требуется
      return FALSE;
    }
    factoryCache_Init();
